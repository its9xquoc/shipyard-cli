...
abstract class Command extends BaseCommand
{
     ...
     *
     * @var \App\Repositories\ShipyardRepository
     */
    protected $shipyard;
    ...
    protected function ensureCurrentTeamIsSet()
    {
        if (! $this->config->get('server', false)) {
            $server = collect($this->shipyard->servers())->first();
