...
trait InteractsWithIO
{
    ...
    public function askForSite($question)
    {
        ...
        $answers = collect($this->shipyard->sites($this->currentServer()->id));
    ...
    public function askForServer($question)
    {
        ...
        $answers = collect($this->shipyard->servers());
    ...
    public function askForDaemon($question)
    {
        ...
        $answers = collect($this->shipyard->daemons($this->currentServer()->id));
