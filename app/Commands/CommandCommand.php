...
class CommandCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $command = $this->shipyard->executeSiteCommand($server->id, $siteId, [
            'command' => $command,
        ]);
        ...
        do {
            ...
            $command = collect($this->shipyard->getSiteCommand($server->id, $siteId, $command->id))->first();
        ...
        $username = $this->shipyard->site($server->id, $siteId)->username;
