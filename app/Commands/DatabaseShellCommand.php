...
class DatabaseShellCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'database:shell {database? : The name of the database} {--user=shipyard : The username of the database user to connect as}';
    ...
    public function handle()
    {
        ...
        $database = $this->argument('database') ?? optional(
            collect($this->shipyard->databases($server->id))->first()
        )->name;
