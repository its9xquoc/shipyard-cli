...
uses(TestCase::class, CreatesApplication::class)
    ->beforeEach(function () {
        ...
        (new Filesystem)->deleteDirectory(base_path('tests/.shipyard'));

        $this->client = tap(Mockery::mock(Shipyard::class), function ($mock) {
        ...
        $this->shipyard = resolve(ShipyardRepository::class)->setClient(
            $this->client
        );
