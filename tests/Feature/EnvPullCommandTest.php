...
it('can pull environment variables generated file', function () {
    ...
    $this->shipyard->shouldReceive('siteEnvironmentFile')->once()->with(1, 2)->andReturn($content);
    ...
    $this->artisan('env:pull')
        ...
        ->expectsOutput('==> Environment Variables Written To [.env.shipyard.2]');
});
...
it('can pull environment variables specific env file', function () {
    ...
    $this->shipyard->shouldReceive('siteEnvironmentFile')->once()->with(1, 1)->andReturn($content);
