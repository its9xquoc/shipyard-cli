...
it('authenticates users', function () {
    ...
    $this->artisan('login')
        ->expectsQuestion('<fg=yellow>‣</> <options=bold>Please Enter Your Shipyard API Token</>', '123123213')
...
it('sets current server', function () {
    ...
    $this->artisan('login')->expectsQuestion('<fg=yellow>‣</> <options=bold>Please Enter Your Shipyard API Token</>', '123123213');
