...
it('can retrieve logs from sites', function () {
    ...
    $this->client->shouldReceive('site')->once()->with(1, 2)->andReturn(
        (object) ['id' => 1, 'name' => 'something.com', 'username' => 'shipyard', 'app' => 'php'],
    );

    $files = [
        '/home/shipyard/something.com/shared/storage/logs/*.log',
        '/home/shipyard/something.com/storage/logs/*.log',
    ];
...
it('can tail logs from sites', function () {
    ...
    $this->client->shouldReceive('site')->once()->with(1, 1)->andReturn(
        (object) ['id' => 1, 'name' => 'pestphp.com', 'username' => 'shipyard', 'app' => 'wordpress'],
    );

    $files = [
        '/home/shipyard/pestphp.com/public/wp-content/*.log',
        '/home/shipyard/pestphp.com/wp-content/*.log',
    ];
